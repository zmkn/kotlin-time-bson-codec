                ...
                pom {
                    ...
                    licenses {
                        license {
                            ...
                            url.set("https://github.com/zmkn/kotlin-time-bson-codec/blob/master/LICENSE")
                        }
                    }
                    developers {
                        developer {
                    ...
                    scm {
                        connection.set("scm:git:https://github.com/zmkn/kotlin-time-bson-codec.git")
                        developerConnection.set("scm:git:git@github.com:zmkn/kotlin-time-bson-codec.git")
                        url.set("https://github.com/zmkn/kotlin-time-bson-codec")
                    }
                }
            }
...
if (localProperties.getProperty("jreleaser.enable") == "true") {
    ...
    configure<JReleaserExtension> {
        project {
            ...
            links {
                homepage.set("https://github.com/zmkn/kotlin-time-bson-codec")
                documentation.set("https://github.com/zmkn/kotlin-time-bson-codec/wiki")
                license.set("https://github.com/zmkn/kotlin-time-bson-codec/blob/master/LICENSE")
                bugTracker.set("https://github.com/zmkn/kotlin-time-bson-codec/issues")
                donation.set("https://github.com/zmkn/kotlin-time-bson-codec")
            }
        }
        signing {
            ...
            maven {
                github {
                    register("github") {
                        ...
                        url.set("https://maven.pkg.github.com/zmkn/kotlin-time-bson-codec")
